...
## 1. Purpose & Scope
- A personal portfolio welcome page for Devin Thomas, a software engineering student at Stevens Institute of Technology.
...
- Hero header: my full name "Devin Thomas", the subtitle "Software Engineering Student at Stevens Institute of Technology", and this bio: "I am a software engineering student interested in building practical technology and improving my programming skills. I enjoy working on projects that combine software, hardware, and problem-solving."
- Action link: a button labelled "See my projects" that links to `#projects`.
- Projects section with id="projects": lists these items:
  - Automated Plant Monitoring System — An ESP32-based system that monitors plant conditions and automates watering.
